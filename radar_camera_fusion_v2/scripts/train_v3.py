"""
Training script v3 for radar-camera fusion model.
Key fixes over train.py:
  ...
  4. Adaptive detection threshold
...
from radar_camera_fusion_v2.utils.tracker import Detection, FusionState
